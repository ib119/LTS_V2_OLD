...
public:
    ...
    void setCurrentSources(){
        currentSources.push_back(new CurrentSource("Is", 2, 2, 1));
    }
    void setConductanceSources(){
        conductanceSources.push_back(new Resistor("r1", 2, 2, 1));
        conductanceSources.push_back(new Resistor("r2", 8, 2, 0));
        conductanceSources.push_back(new Resistor("r3", 4, 3, 0));
    }
